      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center gap-5 md:items-start">
          ...
          >
            <h1>
              Roommate
              <span className={darkMode ? "text-secondary" : "text-secondary"}>
                Finder
              </span>
            </h1>
          </Link>
          <p className={`text-sm mt-3 ${darkMode ? "text-gray-400" : "text-gray-600"} max-w-xs`}>
        ...
        <div className="flex flex-col items-center gap-5 md:items-start">
          <h3
            className={`footer-title uppercase font-semibold mb-2 ${
